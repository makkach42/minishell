...
/*   Updated: 2025/06/20 15:31:26 by aakroud          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_var_helper(t_tree **tree, t_env **h, char **e, int *check, t_hdoc_data *h_data)
{
	reset_vars(tree, h, h_data);
...
void	ft_execute(t_tree *tree, t_env **h, char **e, int *check, t_hdoc_data *h_data)
{
	...
	if (ft_strcmp("VARIABLE", tree->type) == 0)
		ft_var_helper(&tree, h, e, check, h_data);
